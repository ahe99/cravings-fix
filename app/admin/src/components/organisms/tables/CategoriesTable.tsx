...
interface CategoriesTableProps {
  categories: Category[]
  onClickItem?: (productId: Category['_id']) => void
}
interface HeadCell {
  id: keyof Category
  label: string
...
export const CategoriesTable = ({
  ...
  const { orderBy, order, sortFn, updateSort } = useSort<Category>('createdAt')

  const sortedCategoriess = sortFn(categories)
  const paginatedCategoriess = sortedCategoriess.filter(
    (_, index) =>
